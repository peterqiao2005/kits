...
curl -fsSL https://raw.githubusercontent.com/peterqiao2005/kits/main/executor-al/docker-compose.app.yml -o docker-compose.app.yml
curl -fsSL https://raw.githubusercontent.com/peterqiao2005/kits/main/executor-al/.env -o .env
